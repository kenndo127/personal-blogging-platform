...
<nav>
  <ul>
    <a href="dashboard-menu.html"><li><img src="./assets/home-icon.svg" alt="home-icon"> Dashboard</li></a>

    <a href="posts.html"><li><img src="./assets/add-post-icon.svg" alt="add-post-icon"> Add Posts</li></a>

    <a href="edit.html"><li><img src="./assets/edit-icon.svg" alt="edit-icon"> Edit</li></a>

    <a href="settings.html"><li><img src="./assets/settings-icon.svg" alt="settings-icon"> Settings</li></a>
  </ul>
</nav>
